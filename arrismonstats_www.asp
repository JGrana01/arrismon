...
<td class="settingvalue">
<input autocomplete="off" type="text" align="left" autocomplete="on" maxlength="10" class="input_10_table removespacing" name="arrismon_loginname"/>
&nbsp; login name <span style="color:#FFCC00;">(*NA denotes not applicable.)</span>
<input autocomplete="off" type="password" align="left" autocomplete="current-password" maxlength="25" class="input_25_table removespacing" name="arrismon_password"/>
&nbsp;password
</td>
</tr>
